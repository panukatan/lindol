...
For example, if data for a specific year is needed, say for example for year 2024, using parallelisation using 8 parallel processes, then:
...
```{r, usage-bulletin-2b, eval = FALSE, echo = FALSE}
